        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="w-full">
               <CustomVideoPlayer 
                 src={anime.videoUrl} 
                 poster={anime.coverImage || undefined} 
                 title={anime.title}
               />
            </div>
            ...
            <div>
              <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    <Badge variant="outline" className="border-primary/50 text-primary">{anime.quality}</Badge>
                  </div>
                </div>
              ...
              <div className="mt-6 flex items-center gap-4 p-4 rounded-xl bg-secondary/20 border border-white/5">
                <Avatar>
                  <AvatarImage src={anime.uploader?.avatarUrl || undefined} />
                  <AvatarFallback>{anime.uploader?.username.substring(0,2).toUpperCase()}</AvatarFallback>
                </Avatar>
                <div>
                  <p className="text-sm text-muted-foreground">Uploaded by</p>
                  <p className="font-semibold">{anime.uploader?.username}</p>
                </div>
              </div>
            </div>
