...
export default function ShareAnime() {
  ...
  const selectJikanAnime = (anime: any) => {
    form.setValue("myAnimeListId", anime.mal_id);
    form.setValue("animeNev", anime.title);
    form.setValue("leiras", anime.synopsis || "");
    form.setValue("boritokep", anime.images?.jpg?.large_image_url || "");
    form.setValue("mufajok", anime.genres?.map((g: any) => g.name).join(" ") || "");
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Episode Count</FormLabel>
                    <FormControl>
                      <Input {...field} type="number" onChange={e => field.onChange(parseInt(e.target.value))} className="bg-secondary/30" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Genres (space or comma separated)</FormLabel>
                    <FormControl>
                      <Input {...field} className="bg-secondary/30" />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="aktiv" className="bg-secondary/30" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
